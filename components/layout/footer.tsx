  ...
  return (
    <footer className="bg-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              ...
              products. Our mission is to empower our customers through
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href={`/#${SECTION_IDS.FEATURES}`} className="footer-link">
                  Features
                </a>
              </li>
              <li>
                <a href={`/#${SECTION_IDS.PRICING}`} className="footer-link">
                  Pricing
                </a>
              </li>
              <li>
        ...
        <SimpleFooter className="mt-8 border-t pt-8" />
      </div>
    </footer>
  );
}
